...
async def call_model(
    state: State, runtime: Runtime[Config]
    ...
    """
    # Get config with defaults if context not provided
    config = runtime.context or Config()
...
builder = StateGraph(State, input_schema=InputState, context_schema=Config)
