...
def test_create_basic_task():
    ...
    task = create_task(title="Test Task", description="Test Description")
...
def test_create_task_with_priority():
    ...
    task = create_task(title="High Priority Task", priority=Priority.HIGH)
...
def test_create_task_with_dates():
    ...
    task = create_task(title="Scheduled Task", due_date=due, start_date=now)
